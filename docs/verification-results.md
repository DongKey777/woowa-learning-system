...
| qrels strict top1 / learner top1 / NDCG@5 / p95 | **1.000 / 1.000 / 0.987 / 388.8ms** | `reports/cohort_y13_baseline.json` |
| rag_quality top1 / NDCG@5 / p95 | **0.995 / 0.997 / 3.1ms** | `reports/rag_quality_regression.json` |
| full scenario p50/p95 / evidence | **64.5ms / 87.0ms / 96.0%** | `reports/v2_vs_legacy_full_comparison.json` |
...
| first-answer total (canonical release) | **20541.0ms p95** | 43933.6ms | **2.1× faster** |
| warm CLI p95 | **152.1ms** | 431.7ms | **2.8× faster** |
| qrels production p95 | **388.8ms** | 1814.2ms | **4.7× faster** |
| qrels primary/strict top1 | **1.000** | 0.628 | **+37.2pp** |
| 14-scenario full comparison p50/p95 | **64.5ms / 87.0ms** | 88.0ms / 116.6ms | **v2 faster 1.4× / 1.3×** |
