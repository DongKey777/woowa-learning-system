...
bin/index-fetch
```
- GitHub Releases `DongKey777/woowa-learning-system` → `paradigm-v2-index-v1.0.6` (release별 약 13-19MB, SHA256 검증) → `state/index/`
- 소요: ~15초
...
| 새 release tag publish 후 | `bin/sync-index-metadata --tag paradigm-v2-index-v1.0.6` |
